    ...
    >
      ...
      <div className="flex flex-col flex-1 p-6 text-right" dir="rtl">
        <Link to={`/blog/${post.slug}`} className="hover:opacity-75 transition-opacity duration-200">
          <h3 className="text-[20px] md:text-[22px] 2xl:text-[27px] 3xl:text-[33px] font-bold text-[#1a1a1a] leading-snug tracking-[-0.02em] mb-3">
            {post.title}
          </h3>
        </Link>
      ...
      <div>
        ...
        <div ref={headerRef} className="text-center mb-8 md:mb-10 px-4 md:px-16">
          <div className="inline-block">
            <motion.h2
              className="font-bold tracking-[-0.02em] text-[#1a1a1a] leading-none"
