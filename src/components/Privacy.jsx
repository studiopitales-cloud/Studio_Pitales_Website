...
const SECTIONS = [
    ...
    content: (
      <>
        ...
        <p className="text-[14px]">למידע נוסף:<br />
          <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#5d7a87] hover:underline">https://policies.google.com/privacy</a><br />
          <a href="https://www.facebook.com/privacy/policy" target="_blank" rel="noopener noreferrer" className="text-[#5d7a87] hover:underline">https://www.facebook.com/privacy/policy</a>
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: <><p className="mb-3">באפשרותכם לפנות אלינו בכל עת לצורך עיון במידע שנשמר אודותיכם, תיקון מידע שגוי, מחיקת מידע, הסרה מדיוור, או בירור בנושא פרטיות.</p><p>פניות בנושא פרטיות ניתן לשלוח לכתובת: <a href="mailto:studiopitales@gmail.com" className="text-[#5d7a87] hover:underline">studiopitales@gmail.com</a></p></>,
  },
  {
