  ...
  return (
    <>
      ...
      <main className="bg-[#f0ece4] min-h-screen pt-[92px]">
        <div className="max-w-[760px] mx-auto px-6 md:px-8 py-14 md:py-20" dir="rtl">

          <div className="mb-12">
            <p className="text-[11px] tracking-[0.35em] text-[#92a6b4] uppercase mb-4">מסמך משפטי</p>
            <h1 className="text-[28px] md:text-[36px] font-light tracking-[-0.02em] leading-[1.3] mb-4">מדיניות פרטיות</h1>
            <div className="h-[3px] bg-[#92a6b4] w-12 mb-5" />
            <p className="text-[13px] text-[#1a1a1a]/50 font-light">עודכן לאחרונה: 15.05.2026</p>
          </div>

          <div className="mb-10 leading-[2.0] font-light text-[15px] md:text-[16px] space-y-4">
          ...
          <div className="space-y-10 leading-[2.0] font-light text-[15px] md:text-[16px]">
            {SECTIONS.map(({ num, title, content }) => (
              <section key={num}>
                <h2 className="text-[18px] md:text-[20px] font-medium mb-4 pb-3 border-b border-[#92a6b4]/30">
                  {num}. {title}
                </h2>
                {content}
              </section>
