...
const CHAPTER = {
  ...
  body: [
    'מאז ומתמיד תנועה הייתה חלק בלתי נפרד ממני. זה התחיל בריקוד והמשיך לעולם הכושר, שבו עבדתי בעשור האחרון. ניהלתי סטודיו לאימונים פונקציונליים, במקביל למדתי חינוך גופני וגם הספקתי לעבוד כמורה לספורט.',
    ...
    'למדתי שכדי להתמיד צריך מקום שרואה אותך. מקום שכיף להגיע אליו, שמרגישים בו בנוח, ושבאמת אכפת לו מההתקדמות שלך.',
