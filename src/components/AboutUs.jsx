...
const CHAPTER = {
  ...
  body: [
    'מאז ומתמיד תנועה הייתה חלק בלתי נפרד ממני. זה התחיל בריקוד והמשיך לעולם הכושר, שבו גם עבדתי בעשור האחרון. ניהלתי סטודיו לאימונים פונקציונליים והעברתי שיעורי TRX, HIIT וקיקבוקס. במקביל למדתי חינוך גופני וגם הספקתי לעבוד כמורה לספורט.',
