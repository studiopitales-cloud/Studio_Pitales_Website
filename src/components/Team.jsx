...
const members = [
  {
    ...
    years: 8,
    quote: '״את התשוקה שלי מצאתי בפילאטיס והיום אני מעבירה אותה לנשים שרוצות להתמיד בספורט וגם ליהנות ממנו.״',
    img: '/DSC06999.jpg',
  },
  {
    name: 'יובל גבאי',
    ...
    years: 6,
    quote: '״אין יותר מספק מלראות מתאמנת שאמרה \'אני לא יכולה\', ואחרי חודש היא עושה את זה בקלות.״',
    img: '/DSC06963.jpg',
  },
  {
    name: 'נועם אלבז',
